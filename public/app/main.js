...
const OPPONENT_HEIGHT = 5,
    OPPONENT_PICTURE = "files/img/malo.png",
    OPPONENT_PICTURE_DEAD = "files/img/malo_muerto.png",
    OPPONENT_SPEED = 5,
    OPPONENT_WIDTH = 5,
    GAME_OVER_PICTURE = "files/img/game_over.png",
    KEY_LEFT = "LEFT",
    KEY_RIGHT = "RIGHT",
    KEY_SHOOT = "SHOOT",
    MIN_TOUCHMOVE = 20,
    PLAYER_HEIGHT = 5,
    PLAYER_PICTURE = "files/img/bueno.png",
    PLAYER_PICTURE_DEAD = "files/img/bueno_muerto.png",
    PLAYER_SPEED = 20,
    PLAYER_WIDTH = 5,
    SHOT_HEIGHT = 1.5,
    SHOT_SPEED = 20,
    SHOT_PICTURE_PLAYER = "files/img/shot1.png",
    SHOT_PICTURE_OPPONENT = "files/img/shot2.png",
    SHOT_WIDTH = 1.5;
